...
f = open(os.path.join('instances','stp10','stp10a.txt'), 'r')
n = int(f.readline())
f.close()

x, y = np.loadtxt(os.path.join('instances','stp10','stp10a.txt'), skiprows=1, unpack=True)
...
#plt.show() #zakomentirati ovu liniju po potrebi
